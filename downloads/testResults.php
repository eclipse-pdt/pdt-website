...
# Disabled for now (until https://bugs.eclipse.org/bugs/show_bug.cgi?id=274429 is fixed)
# Uncomment this include and remove whole the next PHP section when this bug is fixed
