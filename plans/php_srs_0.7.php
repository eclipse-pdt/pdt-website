...
<P class=MsoBodyTextIndent2 style="MARGIN-LEFT: 21.3pt">PDT is a PHP 
...
<P class=MsoNormal>PDT is a collection of an Eclipse plugins and Eclipse 
features, designed for use in collaboration with existing Eclipse products or as 
a stand-alone product. PDT will be based on WTP project.</P>
...
<P class=MsoNormal>PDT’s main user objective is to answer all PHP developer 
...
PDT should be customizable to work with any downloaded version of the PHP 
